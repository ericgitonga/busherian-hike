...
export const metadata: Metadata = {
  title: "Terms and Conditions — Ngong Hills Hike & After Party",
};

// Reproduces sections 1-18 of extras/clients/busherians/Participant Waiver and Data
// Protection Notice.pdf verbatim (issue #94) — that document predates this site's own "Ngong
// Hills Hike & After Party" branding and uses its own organiser/contact framing ("Alliance
// Classic Run Outdoor Activities and Events", Bush Mountaineering Group), which is kept as-is
// here rather than reworded, since this page's job is to be the thing participants tick the
// Acknowledgement and Declaration checkbox against.
        ...
        >
          <section>
            <p className="font-semibold text-zinc-900">
              FOR Alliance Classic Run Outdoor Activities and Events
            </p>
            <p>
              <strong>Organiser:</strong> Bush Mountaineering Group
              <br />
              <strong>Email:</strong> acr@ahsobc.org
            </p>
            <p>
              <strong>Activity/Event:</strong> Ngong Hills Hike
              <br />
              <strong>Date:</strong> 19th September 2026
              <br />
              <strong>Venue/Location:</strong> Ngong Hills / Impala Club
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>Data Protection Contact:</strong> Limo Sammy
              <br />
              <strong>Email:</strong> acr@ahsobc.org
              <br />
              <strong>Telephone:</strong> 0735 399 887
            </p>
            <p className="mt-2">
